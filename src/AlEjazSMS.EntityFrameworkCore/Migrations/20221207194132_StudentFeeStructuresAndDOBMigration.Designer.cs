...
namespace AlEjazSMS.Migrations
{
    ...
    [Migration("20221207194132_StudentFeeStructuresAndDOBMigration")]
    partial class StudentFeeStructuresAndDOBMigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AlEjazSMS.Branches.Branch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AlEjazSMS.FeeStructures.FeeStructureLineItem", b =>
                {
                    ...
                    b.ToTable("FeeStructureLineItems", (string)null);
                });

            modelBuilder.Entity("AlEjazSMS.FeeTransactions.FeeTransaction", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("AlEjazSMS.Students.StudentFeeStructure", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("StudentFeeStructures", (string)null);
                });
            ...
            modelBuilder.Entity("AlEjazSMS.Classes.Class", b =>
                {
                    b.HasOne("AlEjazSMS.Branches.Branch", "Branch")
                        .WithMany("Classes")
            ...
            modelBuilder.Entity("AlEjazSMS.FeeTransactions.FeeTransaction", b =>
                {
                    b.HasOne("AlEjazSMS.StudentFees.StudentFee", "StudentFee")
            ...
            modelBuilder.Entity("AlEjazSMS.StudentFees.StudentFee", b =>
                {
                    ...
                    b.HasOne("AlEjazSMS.Students.Student", "Student")
                        .WithMany()
            ...
            modelBuilder.Entity("AlEjazSMS.FeeStructures.FeeStructure", b =>
                {
                    ...
                    b.Navigation("StudentFeeStructures");
                });
